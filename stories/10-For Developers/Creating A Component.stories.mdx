...
Radial component names use UpperCamelCase, with no special prefix. They're namespaced by their place in the [atomic design heirarchy](/docs/for-designers-intro--page#atomic-design-principles). To keep atoms extra easy to use, skip extra namespacing and just use the component name. For molecules and organisms, namespace them by putting them in folders, named molecule, or component.
