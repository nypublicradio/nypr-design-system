...
Example: nypr-design-system is an ember addon that plugs into our ember apps (i.e. gothamist-web-client), and it's useful to see how local changes to the addon will affect the consuming app in your local dev environment. This is what yalc is for.
