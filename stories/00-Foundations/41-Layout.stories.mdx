...
| block list group 1col with heading block | 1 lg card, 4 sm cards | <img alt="List" src="./images/Foundations-Layout-1Col-2.jpg" width="200" /> |
| block list group | 2 lg cards, 4 sm cards | <img alt="List" src="./images/Foundations-Layout-1Col-3.jpg" width="200" /> |
