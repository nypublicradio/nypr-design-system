...
<Preview withToolbar={true}>
  <Story name="4x6" height="370px">{{
    template: hbs`
    <div class="u-padding">
      <div class="l-grid l-grid--2x3 l-grid--middle">
        <div><img src="https://via.placeholder.com/768x768?text=1:1" alt="placeholder image"/></div>
...
<Preview withToolbar={true}>
  <Story name="6x6" height="510px">{{
    template: hbs`
   <div class="u-padding">
     <div class="l-grid l-grid--2up l-grid--middle">
       <div class="u-space--bottom u-padding--bottom u-background-color--cool-white">
         <img class="u-space--bottom" src="https://via.placeholder.com/800x400?text=2:1" alt="placeholder image"/>
...
<Preview withToolbar={true}>
  <Story name="HorizontalCard" height="170px">{{
    template: hbs`
      <div class="u-padding">
        <div class="l-grid l-grid--1x4 l-grid--middle">
          <div><img src="https://via.placeholder.com/500x250?text=2:1" alt="placeholder image"/></div>
...
<Preview withToolbar={true}>
  <Story name="Wrappers" height="1100px">{{
    template: hbs`
      <div class="u-padding">
