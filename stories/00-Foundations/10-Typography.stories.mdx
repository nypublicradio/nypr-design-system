...
<table className="sbdocs sbdocs-table">
  ...
  <tbody>
    <tr>
      ...
      <td>TK BOLD, REGULAR EXAMPLES</td>      
    </tr>
    <tr>
      <td>Gothamist, Secondary</td>
      <td><span style={{ fontFamily: 'Barlow', fontWeight: '700', fontSize: '28px' }}>Barlow</span> <br /> is used as a secondary font for body text</td>
      <td>TK BOLD, REGULAR EXAMPLES</td>      
    </tr>
    <tr>
      <td>Gothamist, Tertiary</td>
      <td><span style={{ fontFamily: 'B612 Mono', fontWeight: '700', fontSize: '28px' }}>B612 Mono</span> <br /> is used as a tertiary font for small headers and info text. Since this font is always displayed at a very small size, to help with legibility, this font should always be utilized in all caps, with a letter-spacing of 1.25</td>
      <td>TK BOLD, REGULAR EXAMPLES</td>      
    </tr>
  </tbody>
</table>
