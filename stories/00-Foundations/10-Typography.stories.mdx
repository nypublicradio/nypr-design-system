...
| Type | Font & Description | Example |
| -- | -- | -- |
| Gothamist, Primary | Pragati Narrow <br/>is used as the primary font for headlines and titles, as well as subheaders which are page headings and section headings | **TK** BOLD, REGULAR EXAMPLES |
