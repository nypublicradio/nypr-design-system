...
| Whitelabel, Secondary | Source Sans Pro is used as our default secondary and tertiary font for body text as well as small headers and info text | BOLD, REGULAR, ITALICS EXAMPLES |
| Gothamist, Primary | **Pragati Narrow** <br/>is used as the primary font for headlines and titles, as well as subheaders which are page headings and section headings
 | BOLD, REGULAR EXAMPLES |
