...
<table className="sbdocs sbdocs-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><span style={{ fontFamily: 'Barlow', fontWeight: '400', fontSize: '18px' }}>Aa</span> <span style={{ fontFamily: 'Barlow', fontWeight: '700', fontSize: '18px' }}>Aa</span> <span style={{ fontFamily: 'Barlow', fontWeight: '400i', fontSize: '18px' }}>Aa</span></td>      
    </tr>
    <tr>
