...
| Type | Font & Description | Example |
| -- | -- | -- |
| Whitelabel, Primary | **Libre Baskerville** <br/>is used as our default primary font for headlines and titles, as well as subheaders which are page headings and section headings | **TK** BOLD, REGULAR EXAMPLE |
| Whitelabel, Secondary | **Source Sans Pro** <br/>is used as our default secondary and tertiary font for body text as well as small headers and info text | **TK** BOLD, REGULAR, ITALICS EXAMPLES |
...
<table className="sbdocs sbdocs-table">
  ...
  <tbody>
    <tr>
      ...
      <td><span style={{ fontFamily: 'Libre Baskerville', fontWeight: '700', fontSize: '28px' }}>Libre Baskerville</span> <br /> is used as our default primary font for headlines and titles, as well as subheaders which are page headings and section headings </td>
    ...
    <tr>
      ...
      <td><span style={{ fontFamily: 'Source Sans Pro', fontWeight: '400', fontSize: '28px' }}>Barlow</span> <br /> is used as a secondary font for body text</td>
...
<table className="sbdocs sbdocs-table">
  ...
  <tbody>
    <tr>
      ...
      <td><span style={{ fontFamily: 'Pragati Narrow', fontWeight: '700', fontSize: '28px' }}>Pragati Narrow</span> <br /> is used as the primary font for headlines and titles, as well as subheaders which are page headings and section headings</td>
    ...
    <tr>
      ...
      <td><span style={{ fontFamily: 'Barlow', fontWeight: '400', fontSize: '28px' }}>Barlow</span> <br /> is used as a secondary font for body text</td>
    ...
    <tr>
      ...
      <td><span style={{ fontFamily: 'B612 Mono', fontWeight: '400', fontSize: '28px' }}>B612 Mono</span> <br /> is used as a tertiary font for small headers and info text. Since this font is always displayed at a very small size, to help with legibility, this font should always be utilized in all caps, with a letter-spacing of 1.25</td>
...
| Type | Font & Description | Example |
| -- | -- | -- |
| Gothamist, Primary | Pragati Narrow 
<br/> is used as the primary font for headlines and titles, as well as subheaders which are page headings and section headings | **TK** BOLD, REGULAR EXAMPLES |
| Gothamist, Secondary | **Barlow** <br/>is used as a secondary font for body text. | **TK** BOLD, REGULAR, ITALICS EXAMPLE |
| Gothamist, Tertiary | **B612 Mono** <br/>is used as a tertiary font for small headers and info text. Since this font is always displayed at a very small size, to help with legibility, this font should always be utilized in all caps, with a letter-spacing of 1.25 | **TK** BOLD,<br/>REGULAR EXAMPLES |
...
| Type | Font & Description | Example |
| -- | -- | -- |
| WQXR, Primary | **Playfair Display** <br/>is used as our default primary font for headlines and titles. | **TK** BOLD EXAMPLE |
| WQXR, Secondary | **Open Sans** <br/>is used as our default secondary and tertiary font for body text as well as small headers and info text. | **TK** BOLD, REGULAR EXAMPLES |
