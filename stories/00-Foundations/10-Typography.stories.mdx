...
<table className="sbdocs-table">
  ...
  <tbody>
    <tr>
      ...
      <td><span style={{ fontFamily: 'Pragati Narrow' }}>Pragati Narrow</span> <br /> is used as the primary font for headlines and titles, as well as subheaders which are page headings and             section headings</td>
