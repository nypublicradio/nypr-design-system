...
<table className="sbdocs-table">
  ...
  <tbody>
    <tr>
      ...
      <td>Pragati Narrow <br /> is used as the primary font for headlines and titles, as well as subheaders which are page headings and             section headings</td>
...
| Type | Font & Description | Example |
| -- | -- | -- |
| Gothamist, Primary | <span style={{ fontFamily: 'Pragati Narrow' }}>Pragati Narrow</span> 
