...
<table className="sbdocs sbdocs-table">
  ...
  <tbody>
    <tr>
      <td>WQXR, Primary</td>
      <td><span style={{ fontFamily: 'Playfair Display', fontWeight: '700', fontSize: '28px' }}>Playfair Display</span> <br /> is used as our default primary font for headlines and titles. </td>
    ...
    <tr>
      ...
      <td><span style={{ fontFamily: 'Open Sans', fontWeight: '400', fontSize: '28px' }}>Open Sans</span> <br /> is used as our default secondary and tertiary font for body text as well as small headers and info text. </td>
