...
| Type | Font & Description | Example |
| -- | -- | -- |
| WQXR, Primary | **Playfair Display** <br/>is used as our default primary font for headlines and titles. | BOLD EXAMPLE |
| WQXR, Secondary | **Open Sans** <br/>is used as our default secondary and tertiary font for body text as well as small headers and info text. | BOLD, REGULAR EXAMPLES |
