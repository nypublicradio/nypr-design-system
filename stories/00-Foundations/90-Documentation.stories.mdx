...
When viewing any of the pages within the [stories folder](https://github.com/nypublicradio/nypr-design-system/tree/radial/stories) on GitHub, you can click the pencil icon to edit the file. 
...
From the [stories folder](https://github.com/nypublicradio/nypr-design-system/tree/radial/stories) in GitHub you can click the "Create New File" button to add a new file in any of the folders.
...
Include the image your Markdown like this `![alt text](/images/my-image.png)`.
