...
<Meta title="Foundations/GridAndSpacing" />
...
> | Space 3 | 8px | 16px | 24px |
> | Space 4 | 12px | 24px | 32px |
> | Space 5 | 16px | 32px | 40px |
> | Space 6 | 20px | 40px | 48px |
> | Space 7 | 24px | 48px | 56px |
> | Space 8 | 28px | 56px | 64px |
> | Space 9 | 32px | 64px | 72px |
> | Space 10 | 36px | 74px | 80px |
> | Space 11 | 40px | 84px | 88px |
