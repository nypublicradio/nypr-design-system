...
<Preview>
  <Story name="BaseIcons" height="500px">{{
    template: hbs`
...
<Preview>
  <Story name="GothamistIcons" height="200px">{{
    template: hbs`
    <div class="l-grid l-grid--4up">
      <div>
        <div class="u-flex u-align-items--center u-space--bottom">
...
<Preview>
  <Story name="LogoIcons" height="100px">{{
    template: hbs`
    <div class="l-grid l-grid--4up">
      <div>
        <div class="u-flex u-align-items--center u-space--bottom">
...
<Preview>
  <Story name="WqxrIcons" height="100px">{{
    template: hbs`
    <div class="l-grid l-grid--4up">
      <div>
        <div class="u-flex u-align-items--center u-space--bottom">
...
<Preview>
  <Story name="IconSizes" height="175px">{{
    template: hbs`
          <div class= "u-flex u-align-items--center u-space--bottom">
