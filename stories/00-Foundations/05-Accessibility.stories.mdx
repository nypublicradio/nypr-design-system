...
<img style="padding-top: 14px; padding-bottom:14px;" alt="demonstration of changing the color blindness filter" src="./images/Foundations-ColorBlindnessEmulator.gif" width="50%" height="50%" />
...
<img style="padding-top: 14px; padding-bottom:14px;" alt="accessibility addon with closed accordion" src="./images/Foundations-Accessibility-a11y-addon-accordion-closed.png" width="50%" height="50%" />

<img style="padding-top: 14px; padding-bottom:14px;" alt="accessibility addon with open accordion" src="./images/Foundations-Accessibility-a11y-addon.png" width="50%" height="50%" />
