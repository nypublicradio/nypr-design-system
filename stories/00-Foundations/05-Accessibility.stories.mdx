...
<img alt="demonstration of changing the color blindness filter" src="./images/Foundations-ColorBlindnessEmulator.gif" width="50%" height="50%" padding-top="14px" padding-bottom="14px" />
...
<img alt="accessibility addon with closed accordion" src="./images/Foundations-Accessibility-a11y-addon-accordion-closed.png" width="50%" height="50%" padding-top="14px" padding-bottom="14px" />

<img alt="accessibility addon with open accordion" src="./images/Foundations-Accessibility-a11y-addon.png" width="50%" height="50%" padding-top="14px" padding-bottom="14px" />
