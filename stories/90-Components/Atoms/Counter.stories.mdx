...
For example, <img alt="example of counter configurations" src="./images/Atom-Counter-Configurations.png" width="150" /> should all be read by a screenreader as, "41 comments." 
