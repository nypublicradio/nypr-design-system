...
<Preview withToolbar={true}>
  <Story name="icon" height="80px">{{
    template: hbs`<Button @icon="audio" @iconAlt="Play" class="mod-small"/> 
<Button @icon="audio" @iconAlt="Play" />
...
<Preview withToolbar={true}>
  <Story name="flat" height="80px">{{
    template: hbs`<Button @label="Button" class="mod-flat mod-small"/> 
<Button @label="Button" class="mod-flat" />
<Button @label="Button" class="mod-flat mod-large"/> `
  }}</Story>
</Preview>
