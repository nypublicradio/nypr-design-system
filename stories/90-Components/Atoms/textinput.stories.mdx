...
5- **Microcopy** - This assistive text appears below the input label and helps the user to provide the right information. This is also used for error messaging when their is a problem with user input.
...
#### **Error**
If an error occurred when submitting the form, the form element should provide feedback to the user by displaying a changed container stroke and error text microcopy, usings the brand’s accent color for error
