...
In this state, the user hasn’t yet interacted with the input, but it's prepped and ready to accept input.
 <img alt="example of default textarea" src="./images/Molecules-TextArea-DefaultState.png" width="250" />
<br/><br/>
...
Labels must have the for attribute matching the ID of the textarea, like `<input id="unique-id-of-input"/>`. This practice ensures that screen readers inform users correctly about what information to enter where.
