...
In the default state, the user has not yet interacted with the link, but it's active and patiently waiting to be clicked.
 <img alt="example of default link" src="./images/Atoms-Links-DefaultState.png" width="50" />
  <br/><br/>
...
<img alt="example of hover link" src="./images/Atoms-Links-HoverState.png" width="50" />
  <br/><br/>
...
<img alt="example of disabled link" src="./images/Atoms-Links-DisabledState.png" width="50" />
  <br/><br/>
...
<img alt="example of a visited link" src="./images/Atoms-Links-VisitedState.png" width="50" />
  <br/><br/>
