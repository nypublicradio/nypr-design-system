...
If a link drives to an interal page, that page should open in the same tab when clicked.
...
If a link drives to an external page, that page should open in a new tab when clicked.
