...
3- **Primary Navigation** - Top level links to larger areas of a site’s domain. Also called "Global Navigation." Use this area for links before using the Secondary Navigation. This is required.
...
9- **Secondary Navigation** - Links to inner site pages or lower-level areas of the site, includes optional subheader. This is optional.
