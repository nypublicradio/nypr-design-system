...
5. 5 - **Copyright Text and Attribution** - Placeholder area for copyright and links (ex: © 2020 New York Public Radio)

6. 6 - **NYPR Brand Roll** - Collection of the NYPR family of properties, find more documentation on this component here(TK)

7. 7 - **Horizontal Component Area** - Flexible area for custom components to be dropped in as needed. (ex: Sign Up Form, Search, Donate Button, etc)

8. 8 - **Social Links** - Link off to a brand's social media accounts

9. 9 - **Secondary Navigation** - Links to inner site pages or lower-level areas of the site, includes optional subheader.
