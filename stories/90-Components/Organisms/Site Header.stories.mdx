...
1. 1 - **Hamburger Menu** - If a site supports sidebar menus, the hamburger navigation is used to launch the menu. More typically seen on mobile where navigation items are shifted from site header to side menu.
...
6. 6 - **Search** - Icon that launches a form field on click. This action hides all items on the right side of the site header to make visual space for the search field.
