...
6. 6- Search - Icon that launches a text-field on click.

  

## States

Depending on the platform, a brand bar can have a number of configurations (states). In Gothamist, our brand bar swaps it’s primary navigation for a headline when on an article page. Configuration options are built-in to our whitelabel component and will expand as we incorporate more brands into Radial.
...
On mobile, brand bars can hide the majority of their components to fit the narrow screen. In these cases, a Side Menu can be triggered via a hamburger menu or similar icon to show primary and secondary navigation.
