...
Cards can hold information like text or images while providing functionality through links and buttons. Information held in cards should be scannable and easily digestible. If an article is a full meal, cards are merely a snack.

  

### Anatomy

Radial provides a bunch of functionality for cards that can be switched on or off to best fit your needs.
