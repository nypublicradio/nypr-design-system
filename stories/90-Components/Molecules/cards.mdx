...
## Card Types
There are two different types of cards: Horizontal and Vertical cards. Either of the cards should be used whenever they correspond with in  context with the area they're being displayed in. For example: Horizontal cards should be utilized when the space that needs to be filled is horizontal, and vice versa for Vertical cards.
...
| Card Type | Examples |
| -- | -- |
| Horizontal, Small (Gothamist) | x |
| Horizontal, Large (Gothamist) | x |
| Verticle, Large (Gothamist) | x |
