...
| Card Type | Examples |
| -- | -- |
| Horizontal, Small  | <img alt="example of small horizontal card" src="./images/Molecules-Cards-Small-Horizontal-Card.png"/> |
| Horizontal, Large  | <img alt="example of large horizontal card" src="./images/Molecules-Cards-Large-Horizontal-Card.png"/>|
| Vertical, Small  | <img alt="example of small vertical card" src="./images/Molecules-Cards-Small-Vertical-Card.png"/> |
| Vertical, Large  | <img alt="example of large vertical card" src="./images/Molecules-Cards-Large-Vertical-Card.png"/> |
