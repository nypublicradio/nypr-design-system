...
Title: Max-length of 3 lines of text (mobile)
...
The Breaking News Banner should use the same rules set for Cards. Required fields include:  “Breaking News” label, Headline, and Timestamp.
