...
By default, a tooltip loads in its closed state so that it's contents of the menu are hidden from view to the user. Only the trigger object is visable in this closed state
<br/>
