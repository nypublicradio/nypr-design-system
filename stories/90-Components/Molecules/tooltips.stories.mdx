...
Tooltips are floating pieces of contextual information about an element on screen that help a user to better understand something onsite. They are displayed when a user hovers or focuses on the element it is describing. Tooltips can be attached to links, text, buttons, or inputs. If the information is critical for the user to achieve a task, keep the information clear onsite rather than hiding within a tooltip.
