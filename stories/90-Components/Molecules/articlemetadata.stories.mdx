...
1- **Authors** - The display name of a person(s) who has authored the content. Authors named can be linked to the authors profile if applicable. If content is by a single  author, display like "By John Doe". If Content Item is by two  authors, display like "By John Doe and Jill Doe".  
...
3-**Publish Date** - Time when the article was published. Part of the timestamp component.

  
4- **Updated Date** - Time when the article was last updated. Part of the timestamp component.
  

5-**Comment Count** - If an article has comments, displays the # of comments an article has received in the format "# Comment(s)." where the "s" is included when there are >1 comments.

  

6- **Photos** - If an article has photos, displays the # of photos in an article gallery in the format "# Photo(s)." where the s is included when there are >1 photos.
